...
/**
 * This is a dirty hack to temporary deploy app to Vercel
 * until I migrate it to Yandex Cloud, but still use the
 * database hosted in the YC
 */
const cert = `
-----BEGIN CERTIFICATE-----
...
const client = postgres(process.env.DATABASE_URL, config);
